...
MAP_TYPES = {
    ...
    "DefaultDirectionInComponentSpace": {
        "Key": "",
        "Value": "Vector"
    },
    "NamedWorldRegions": {
    ...
    "TrackSignatureToTrackIdentifier": {
        "Key": "Guid",
        "Value": "MovieSceneTrackIdentifier"
    },
    "LabelToIdCache": {
        "Key": "",
        "Value": "Guid"
    ...
    "SubSequences": {
        "Key": "MovieSceneSequenceID",
        "Value": ""
    },
    "EventTracks": {
        "Key": "",
        "Value": "CacheEventTrack"
    },
    "BoundActorComponents": {
        "Key": "Guid",
        "Value": ""
    },
    "ActiveAbilities": {
...
FACTORY_MAP = {
    ...
    "BinkMediaPlayer": [
        "BinkMediaPlayerFactory",
        "BinkMediaPlayerFactoryNew"
    ],
    "BinkMediaTexture": [
        "BinkMediaTextureFactoryNew"
    ],
    "BlackboardData": [
    ...
    "Blueprint": [
        ...
        "LiveLinkBlueprintVirtualSubjectFactory"
    ],
    "DataTable": [
        "CSVImportFactory",
        "DataTableFactory",
    ...
    "ChaosCacheCollection": [
        "CacheCollectionFactory"
    ],
    "CameraAnim": [
        "CameraAnimFactory"
    ],
    "CameraAnimationSequence": [
        "CameraAnimationSequenceFactoryNew"
    ],
    ...
    "ControlRigGizmoLibrary": [
        "ControlRigGizmoLibraryFactory"
    ],
    "ControlRigSequence": [
    ...
    "DataprepAsset": [
        "DataprepAssetFactory"
    ],
    "DataprepAssetInstance": [
        "DataprepAssetInstanceFactory"
    ],
    "DialogueVoice": [
    ...
    "FileMediaSource": [
        "FileMediaSourceFactoryNew",
        "MfFileMediaSourceFactory",
        "WebMPlatFileMediaSourceFactory",
        "WmfFileMediaSourceFactory"
    ],
    "FoliageType_Actor": [
        "FoliageType_ActorFactory"
    ],
    ...
    "ImgMediaSource": [
        "ImgMediaSourceFactory",
        "ImgMediaSourceFactoryNew"
    ],
    "InterpData": [
    ...
    "MediaPlayer": [
        "MediaPlayerFactoryNew"
    ],
    "MediaPlaylist": [
        "MediaPlaylistFactoryNew"
    ],
    "MediaTexture": [
        "MediaTextureFactoryNew"
    ],
    "Model": [
        "ModelFactory"
    ],
    ...
    "MotoSynthPreset": [
        "MotoSynthPresetFactory"
    ],
    "MotoSynthSource": [
        "MotoSynthSourceFactory"
    ],
    "NiagaraScript": [
